...
public class GeneralController {
	...
	public String approveTheatre(HttpSession session, ModelMap map)
	{
		if(session.getAttribute("admin")!=null)
		{
			...
			if(list.isEmpty())
			{
				session.setAttribute("failure", "No theatre is for approval request");
				return "redirect:/";
			}
			else {
				map.put("list", list);
	...
	public String addMovie(HttpSession session, ModelMap map) {
		if(session.getAttribute("admin")!=null)
		{
			...
			session.setAttribute("fai;ure", "invalid Session, login again");
			return "redirect:/login";
		}
	}
	...
	public String addMovie(HttpSession session, ModelMap map, Movie movie, @RequestParam MultipartFile image)
		...
		if(session.getAttribute("admin") !=null) {
			...
			session.setAttribute("failure", "Invalid Success, Login Again!");
			return "redirect:/login";
